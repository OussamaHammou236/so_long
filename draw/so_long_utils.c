...
/*   Updated: 2024/01/28 10:49:39 by ohammou-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	anime_check(int key, t_draw *data)
{
	...
	if ((data->map[data->pos_y - 1][data->pos_x] == 'N' && key == 126)
			|| (data->map[data->pos_y - 1][data->pos_x] == 'n' && key == 126))
		ft_error("khesrti :(");
	if ((data->map[data->pos_y][data->pos_x - 1] == 'N' && key == 123)
			|| (data->map[data->pos_y][data->pos_x - 1] == 'n' && key == 123))
		ft_error("khesrti :(");
	if ((data->map[data->pos_y][data->pos_x + 1] == 'N' && key == 124)
			|| (data->map[data->pos_y][data->pos_x + 1] == 'n' && key == 124))
		ft_error("khesrti :(");
	if ((data->map[data->pos_y + 1][data->pos_x] == 'N' && key == 125)
			|| (data->map[data->pos_y + 1][data->pos_x] == 'n' && key == 125))
		ft_error("khesrti :(");
	check_c(key, data);
}
